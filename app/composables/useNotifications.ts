...
export function useNotifications() {
  ...
  function notify(
    ...
    title: string,
    message?: string,
    options: { toast?: boolean; duration?: number } = {},
  ): number {
  ...
  return {
    ...
    markHandled,
    markAllHandled,
    info: (t: string, m?: string, o?: { duration?: number }) => notify('info', t, m, o),
    success: (t: string, m?: string, o?: { duration?: number }) => notify('success', t, m, o),
    warning: (t: string, m?: string, o?: { duration?: number }) => notify('warning', t, m, o),
    danger: (t: string, m?: string, o?: { duration?: number }) => notify('danger', t, m, o),
  }
}
